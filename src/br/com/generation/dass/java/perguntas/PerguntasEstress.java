...
public class PerguntasEstress {
	...
	return pergunta16.esqueletoPerguntas("Tive a tendência de reagir de forma exagerada às situações ", " 1- Não se aplicou de maneira alguma \n "
				+ "2- Aplicou-se em algum grau, ou por pouco de tempo \n "
				+ "3- Aplicou-se em um grau considerável, ou por uma boa parte do tempo \n 4- Aplicou-se muito, ou na maioria do tempo");
	}
	...
	return pergunta18.esqueletoPerguntas("Senti-me agitado ", " 1- Não se aplicou de maneira alguma \n "
				+ "2- Aplicou-se em algum grau, ou por pouco de tempo \n "
				+ "3- Aplicou-se em um grau considerável, ou por uma boa parte do tempo \n 4- Aplicou-se muito, ou na maioria do tempo");
	}
	...
	public int questao19() {
		...
		return pergunta19.esqueletoPerguntas("Achei difícil relaxar ", " 1- Não se aplicou de maneira alguma \n "
					+ "2- Aplicou-se em algum grau, ou por pouco de tempo \n "
					+ "3- Aplicou-se em um grau considerável, ou por uma boa parte do tempo \n 4- Aplicou-se muito, ou na maioria do tempo");
	}
