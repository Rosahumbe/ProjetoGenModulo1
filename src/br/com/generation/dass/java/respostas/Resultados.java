	...
	public void resultadoAnsiedade(int somaAnsiedade) {
		...
		if (somaAnsiedade >= 1 && somaAnsiedade <= 7) {
			System.out.println(" Dimensão de Ansiedade - Normal\n"
					+ " 	Sua pontuação sobre a dimensão de ansiedade demonstra que \n 	vocênão está ansioso(a).");
		} else if (somaAnsiedade > 7 && somaAnsiedade <= 14) {
			System.out.println(" Dimensão de Ansiedade - Leve\n"
					+ " 	Sua pontuação sobre a dimensão ansiosa não está elevada, entretanto,\n 	esteja atento à essa dimensão, fale com seu médico a respeito.");
		} else if (somaAnsiedade > 14 && somaAnsiedade <= 21) {
			System.out.println(" Dimensão de Ansiedade - Grave\n"
					+ " 	Sua pontuação na escala de ansiedade está elevada. É importante falar\n 	com o seu médico a fim de traçar uma conduta.");
		} else {
	...
	public void resultadoEstresse(int somaEstresse) {
		if (somaEstresse >= 1 && somaEstresse <= 9) {
			...
			System.out.println(" Dimensão de Estresse - Grave\n"
					+ " 	Os resultados demonstram um nível elevado de estresse. Você deve\n 	estar se sentindo exaurido pelos fatores estressantes do cotidiano.\n A tensão emocional produzida pelo acúmulo de fatores estressantes,\n o colocam sob risco de apresentar sintomas em um ou vários campos:\n relacional, intelectual, físico ou psíquico.");
		}
		System.out.println("");
	}
	...
	public void resultadoDepressao(int somaDepressao) {
		if (somaDepressao >= 1 && somaDepressao <= 7) {
			...
			System.out.println(" Dimensão de Depressão - Moderado\n"
					+ " 	Sua pontuação na escala de depressão está elevada. É importante\n 	falar com o seu médico a fim de traçar uma conduta.");
